  ...
  return (
    <>
      ...
      <>
        ...
        <ul>{filteredList.filter(product => search == "" ? true : product.title.toLowerCase().startsWith(search)).map(product => <li key={product.id}>{product.title} ${product.price}</li>)}</ul>
      </>
      }
    </>
  )
